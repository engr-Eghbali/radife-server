	...
	if r.Method == "POST" {
		...
		if flg {
			...
			for i, item := range results {
				...
				resp = resp + " <div class=\"hisrow\" id=\"hisrowgood" + item.ID.Hex() + "\"><p1>" + i + "</p1><p2>" + item.DateOut + "<br>" + item.TimeOut + "</p2><p3>" + item.Total + "تومان</p3><p4><i class=\"fas fa-times\" style=\"color:#ff0000;\"> </i></p4></div>"
			}
